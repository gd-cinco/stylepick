...
public interface ItemMapper {
	...
	@Insert("insert into item (item_no, userid, code, category, subject, item_name, price, keyword, imgurl, content, regdate, readcnt, item_option, size)"
