...
DROP DATABASE IF EXISTS `stylepick`;
...
-- 테이블 데이터 stylepick.buy:~21 rows (대략적) 내보내기
DELETE FROM `buy`;
...
CREATE TABLE IF NOT EXISTS `buy_detail` (
  ...
  `detail` varchar(200) DEFAULT NULL COMMENT '요청사항',
...
-- 테이블 데이터 stylepick.buy_detail:~19 rows (대략적) 내보내기
DELETE FROM `buy_detail`;
/*!40000 ALTER TABLE `buy_detail` DISABLE KEYS */;
INSERT INTO `buy_detail` (`order_no`, `seq`, `item_no`, `quantity`, `detail`, `item_option`, `size`, `stat`, `reviewed`) VALUES
	(1, 1, 1, 2, NULL, '1', '0', 2, 1),
	(1, 2, 2, 1, NULL, '2', '0', 2, 0),
	(2, 1, 2, 2, NULL, '1', '0', 2, 0),
	(3, 1, 2, 2, NULL, '1', '0', 1, 0),
	(4, 1, 2, 2, NULL, '1', '0', 1, 0),
	(5, 1, 2, 2, NULL, '1', '0', 1, 0),
	(6, 1, 2, 2, NULL, '1', '0', 0, 0),
	(7, 1, 2, 2, NULL, '1', '0', 0, 0),
	(8, 1, 2, 2, NULL, '1', '0', 0, 0),
	(9, 1, 2, 2, NULL, '1', '0', 1, 0),
	(10, 1, 2, 2, NULL, '1', '0', 1, 0),
	(11, 1, 4, 2, NULL, '1', '0', 0, 0),
	(15, 1, 1, 2, NULL, '1', '1', 0, 0),
	(17, 1, 5, 3, NULL, '3', '1', 0, 0),
	(18, 1, 5, 3, NULL, 'test4', 'test', 0, 0),
	(19, 1, 5, 4, NULL, 'test2', 'test', 0, 0),
	(20, 1, 3, 4, NULL, 'test', 'test', 0, 0),
	(21, 1, 5, 3, NULL, 'test4', 'test', 0, 0),
	(21, 2, 1, 8, NULL, 'test', 'test', 0, 0);
...
-- 테이블 데이터 stylepick.comment:~10 rows (대략적) 내보내기
DELETE FROM `comment`;
...
INSERT INTO `item` (`item_no`, `userid`, `code`, `category`, `subject`, `item_name`, `price`, `keyword`, `pictureUrl`, `content`, `regdate`, `readcnt`, `item_option`, `size`) VALUES
	(1, 'admin', 'ㅇㄴㅁ', 1, 'test1', 'test1', 10000, 'test', 'S_10.jpg', 'test', '2020-08-21 16:00:36', 245, 'test,test,test,test,test', 'test,test,test,test'),
	(2, 'admin', 'test', 1, 'test2', 'test2', 10000, 'test', 'pic07.png', 'test', '2020-08-21 17:21:15', 71, 'test,test,test,test,test', 'test,test,test,test'),
	(3, 'admin', 'test', 6, 'test22', 'test3', 10000, 'test', 'pic00.png', 'test', '2020-08-24 10:05:05', 13, 'test,test,test,test,test', 'test,test,test,test'),
	(4, 'admin', 'test', 4, 'test22', 'test4', 10000, 'test', 'S_4.jpg', 'test', '2020-08-24 10:05:39', 4, 'test,test,test,test,test', 'test,test,test,test'),
	(5, 'admin', 'test', 5, 'test22', 'test5', 10000, 'test', 'S_4.jpg', 'test', '2020-08-24 10:06:47', 13, 'test1,test2,test3,test4,test5', 'test,test,test,test');
...
-- 테이블 데이터 stylepick.item_qna:~4 rows (대략적) 내보내기
...
INSERT INTO `item_qna` (`qna_no`, `item_no`, `type`, `userid`, `content`, `regdate`, `grp`, `grplevel`, `grpstep`) VALUES
	(1, 1, 0, NULL, NULL, '2020-08-24 16:04:50', 1, 0, 0),
	(2, 1, 0, NULL, NULL, '2020-08-24 16:04:51', 2, 0, 0),
	(3, 2, 0, '', '고침 수고링', '2020-08-24 16:55:58', 3, 0, 0),
	(4, 1, 0, '', 'dsadasd', '2020-08-24 17:27:18', 4, 0, 0);
...
-- 테이블 데이터 stylepick.line:~16 rows (대략적) 내보내기
DELETE FROM `line`;
/*!40000 ALTER TABLE `line` DISABLE KEYS */;
INSERT INTO `line` (`line_no`, `item_no`, `userid`, `content`, `evaluation`, `regdate`, `order_no`, `seq`) VALUES
	(1, 1, 'jieun', '좋음', 5, '2020-08-01 18:14:23', NULL, NULL),
	(2, 1, 'gaeun', '좋음', 3, '2020-08-03 18:14:23', NULL, NULL),
	(3, 1, 'max', '별로', 2, '2020-08-05 18:14:23', NULL, NULL),
	(4, 1, 'stefan', '별로', 3, '2020-08-10 18:14:23', NULL, NULL),
	(5, 1, 'jennie', 'good', 5, '2020-08-15 18:14:23', NULL, NULL),
	(6, 1, 'admin', '좋음', 4, '2020-08-24 13:22:50', 1, 1),
	(7, 2, 'admin', '1234', 4, '2020-08-24 13:49:19', NULL, NULL),
	(8, 2, 'admin', '1234', 4, '2020-08-24 14:07:41', NULL, NULL),
	(9, 2, 'admin', 'asdf', 4, '2020-08-24 14:12:20', NULL, NULL),
	(10, 2, 'admin', '123456', 5, '2020-08-24 14:24:16', NULL, NULL),
	(11, 1, 'admin', 'tq', 4, '2020-08-24 15:45:00', NULL, NULL),
	(12, 1, 'abcdef', '5점줌', 5, '2020-08-24 15:54:59', NULL, NULL),
	(13, 2, '', '너도그래?\r\n', 4, '2020-08-24 16:51:43', NULL, NULL),
	(14, 1, '', 'dasda', 4, '2020-08-24 17:27:01', NULL, NULL),
	(15, 1, '', 'dasdas', 5, '2020-08-24 17:27:06', NULL, NULL),
	(16, 1, '', '별루...', 2, '2020-08-24 17:53:39', NULL, NULL);
...
-- 테이블 데이터 stylepick.sns:~10 rows (대략적) 내보내기
DELETE FROM `sns`;
...
-- 테이블 데이터 stylepick.snsitem:~9 rows (대략적) 내보내기
DELETE FROM `snsitem`;
...
-- 테이블 데이터 stylepick.sns_like:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 stylepick.user:~11 rows (대략적) 내보내기
DELETE FROM `user`;
...
INSERT INTO `user` (`no`, `userid`, `password`, `nickname`, `email`, `tel`, `age`, `imgurl`, `gender`, `comment`, `sns_type`, `sns_id`, `seller`, `name`, `com_name`, `com_regist`, `com_img`, `com_tel`, `regdate`, `address`, `order_memo`, `order_tel`) VALUES
	(1, 'admin', '1234', '관리자', 'admin@stylepick.shop', ' 012345678', 26, NULL, 1, '관리자입니다.', NULL, NULL, 1, '김관리', 'Una Coop', '1234', NULL, '1234', '2020-08-13 18:28:21', NULL, NULL, NULL),
	(2, 'test4', 'test4', 'test45', 'test4@aaa.com', '', 21, NULL, 1, '', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '2020-08-14 10:01:58', NULL, NULL, NULL),
